...
public class BaseActivity extends ATEActivity implements ServiceConnection {
    ...
    private PlaybackStatus mPlaybackStatus;//广播
    ...
    protected void onStart() {
        ...
        registerReceiver(mPlaybackStatus, filter);//注册广播
    ...
    protected void onDestroy() {
        ...
        try {
            unregisterReceiver(mPlaybackStatus);//注销广播
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()) {
            ...
            case R.id.action_settings:
                NavigationUtil.navigateToSettings(this);//设置
                return true;
            case R.id.action_equalizer:
                NavigationUtil.navigateToEqualizer(this);//均衡器
                return true;
